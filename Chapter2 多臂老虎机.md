...
在我们的k臂老虎机问题中，每个拉杆被选择时，都会有一个期望或平均奖励，我们将平均奖励称为该动作的价值。我们用A<sub>t</sub>表示在t时刻做的选择，选择A<sub>t</sub>的奖励用R<sub>t</sub>表示。任意操作a的价值用q<sub>*</sun>(a)表示，q<sub>*</sun>(a)是行动a的预期奖励：
